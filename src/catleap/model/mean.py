...
with open("./prediction_result_no-remix.md", "w") as f:
    ...
    recall1 = round(statistics.mean([jl["recall"] for jl in json_load["score"]]), 2)
    f11 = round(statistics.mean([jl["f1"] for jl in json_load["score"]]), 2)

    f.write("| CTScore-{} | {} | {} | {} |".format(8, precision, recall, f1) + "\n")
    f.write("| CTScore-{} | {} | {} | {} |".format(15, precision1, recall1, f11) + "\n")
