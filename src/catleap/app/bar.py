...
print("BAS_TO_DEV mean: " + str(statistics.mean(bas_to_dev)) + " median: " + str(statistics.median(bas_to_dev)))
print("DEV_TO_MAS mean: " + str(statistics.mean(dev_to_mas)) + " median: " + str(statistics.median(dev_to_mas)))

draw_boxplot(BoxPlot(
