...
before_positive = merged_df[(merged_df['Class_before'] == merged_df['PredClass_before']) & (merged_df['Class'] != merged_df['PredClass'])]
positive = merged_df[(merged_df['Class_before'] != merged_df['PredClass_before']) & (merged_df['Class'] == merged_df['PredClass'])]
dupli_positive = merged_df[(merged_df['Class_before'] == merged_df['PredClass_before']) & (merged_df['Class'] == merged_df['PredClass'])]
negative = merged_df[(merged_df['Class_before'] != merged_df['PredClass_before']) & (merged_df['Class'] != merged_df['PredClass'])]
